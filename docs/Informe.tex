...
\begin{figure}[ht]
  ...
  \begin{subfigure}[a]{1\linewidth}
    ...
    \caption{Fig. 5.2.1: Basic Function}
  \end{subfigure}
  \begin{subfigure}[b]{1\linewidth}
    \includegraphics[width=\linewidth]{images/advanced_function.png}
    \caption{Fig. 5.2.1: Advanced Function}
  \end{subfigure}
\end{figure}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[a]{1\linewidth}
    ...
    \caption{Fig. 5.3.1: CustomLogger}
  \end{subfigure}
\end{figure}
